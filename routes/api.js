  ...
  loadSingle(req.params.name, req.params.permlink, function (post) {
    if (post) {
      ...
      VALUES
          ...
          '${post.json_metadata.basics.description}','${post.json_metadata.rewards}','${post.json_metadata.goals}','${post.json_metadata.thanks.message}','${post.json_metadata.basics.description}',
